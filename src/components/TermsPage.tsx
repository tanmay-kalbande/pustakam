    ...
    return (
        <div className="fixed inset-0 z-[100] bg-[var(--bg-base)] overflow-auto">
            ...
            <main className="max-w-4xl mx-auto px-6 py-12">
                <div className="mb-12">
                    <span className="text-[11px] font-mono tracking-[0.3em] uppercase text-[var(--brand)] mb-4 block">Legal</span>
                    <h1 className="text-4xl md:text-5xl font-bold text-[var(--text-primary)] mb-6">Terms of Service</h1>
                    <p className="text-[var(--text-muted)] text-lg">Last updated: February 2026</p>
                </div>
