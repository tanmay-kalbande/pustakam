...
export const Toast: React.FC<ToastProps> = ({ message, type, onClose, duration = 4000 }) => {
    ...
    const getIcon = () => {
        switch (type) {
            ...
            case 'warning': return <AlertTriangle size={20} className="text-white/70" />;
            case 'info':
            default: return <Info size={20} className="text-white/70" />;
        }
    };
    ...
    const getTypeStyles = () => {
        switch (type) {
            ...
            case 'warning': return 'border-white/20 bg-[#111111]';
            case 'info':
            default: return 'border-white/10 bg-[#111111]';
        }
    };
