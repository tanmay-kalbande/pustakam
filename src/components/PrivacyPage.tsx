        ...
        <div className="fixed inset-0 z-[100] bg-[#050505] overflow-auto">
            ...
            <main className="max-w-4xl mx-auto px-6 py-12">
                <div className="mb-12">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold text-[var(--text-primary)] mb-6">Privacy Policy</h1>
                    <p className="text-[var(--text-muted)] text-lg">Last updated: January 2026</p>
                </div>
