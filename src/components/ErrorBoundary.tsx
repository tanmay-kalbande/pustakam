                    ...
                    <div className="max-w-md w-full bg-[#121218] border border-white/10 rounded-2xl p-8 text-center">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className="flex-1 py-2.5 bg-amber-500 hover:bg-amber-600 text-black text-sm font-bold rounded-lg flex items-center justify-center gap-2 transition-colors"
                            >
                                <RefreshCw size={16} />
                                Reload App
                            </button>
