...
export function CompliancePage({ onClose }: CompliancePageProps) {
    return (
        <div className="fixed inset-0 z-[100] bg-[var(--bg-base)] overflow-auto font-sans">
            {/* Header */}
            ...
            <main className="max-w-4xl mx-auto px-6 py-12">
                <div className="mb-12">
                    <span className="text-[11px] font-mono tracking-[0.3em] uppercase text-amber-500 mb-4 block">Platform Integrity</span>
                    <h1 className="text-4xl md:text-5xl font-bold text-[var(--text-primary)] mb-6 tracking-tight">System Regulatory Compliance</h1>
                ...
                <div className="space-y-16">
                    ...
                    <section className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                            <div className="p-5 rounded-xl bg-[var(--bg-surface)] border border-[var(--border-subtle)]">
                                <h3 className="text-[var(--text-primary)] font-medium mb-2 flex items-center gap-2">
                                    <Lock size={16} className="text-blue-400" /> Client-Side Storage
                                </h3>
                                <p className="text-[var(--text-secondary)] text-sm">Books and sessions are stored in IndexedDB/LocalStorage. We cannot access your content once generated.</p>
                            </div>
                            <div className="p-5 rounded-xl bg-[var(--bg-surface)] border border-[var(--border-subtle)]">
                                <h3 className="text-[var(--text-primary)] font-medium mb-2 flex items-center gap-2">
                                    <Globe size={16} className="text-emerald-400" /> Zero Data Training
                                </h3>
                                <p className="text-[var(--text-secondary)] text-sm">Pustakam does not use your books to train AI models. Your interactions are between you and your chose LLM provider.</p>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="bg-purple-500/5 border border-purple-500/20 p-6 rounded-2xl space-y-4">
                            <div className="flex items-start gap-3">
                                ...
                                <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
                                    <strong>Content Responsibility:</strong> Users are responsible for ensuring that the content generated via Pustakam complies with the Terms of Service of the respective AI providers (Google, Mistral, Groq).
                                </p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="space-y-6 pt-10 border-t border-[var(--border-subtle)]">
                        ...
                        <div className="space-y-4 text-[var(--text-secondary)]">
                            <div className="flex gap-4">
                                <div className="w-8 h-8 rounded-full bg-[var(--bg-surface)] flex items-center justify-center shrink-0 text-[var(--text-primary)] font-bold text-sm">1</div>
                                <div>
                                    <h3 className="text-[var(--text-primary)] font-medium mb-1">GDPR & CCPA Compliant</h3>
                                    <p className="text-[var(--text-muted)] text-sm">Since data is stored locally, you have total control (Right to Erasure/Access) via your browser settings.</p>
                                </div>
                            </div>
                            <div className="flex gap-4">
                                <div className="w-8 h-8 rounded-full bg-[var(--bg-surface)] flex items-center justify-center shrink-0 text-[var(--text-primary)] font-bold text-sm">2</div>
                                <div>
                                    <h3 className="text-[var(--text-primary)] font-medium mb-1">Open Standards</h3>
                                    <p className="text-[var(--text-muted)] text-sm">We use open JSON and Markdown standards for library exports to prevent vendor lock-in.</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="pt-12 border-t border-[var(--border-subtle)] text-center">
                        <div className="flex items-center justify-center gap-2 text-[var(--text-muted)] text-sm mb-4">
                            <AlertCircle size={14} />
